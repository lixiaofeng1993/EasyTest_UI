...
from base.models import Element as element
from base.models import Environment as environment
from base.models import Keyword as keyword
from base.models import Page as page
from base.models import Project as project
from base.models import Result, Task, LoginConfig, EnvironmentLogin, TaskRelation, SplitResult
from base.models import TestCase as testcase, Browser
from base.models import Params, Browser
...
class Project:
    ...
    def create(request):
        ...
        p = project()
        p.team_id = request.session.get('tid', '')
